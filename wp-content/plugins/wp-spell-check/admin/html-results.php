...
<div id="wpsc-dialog-confirm" title="Are you sure?" style="display: none;">
  <p>Would you like to Proceed with the changes?</p>
		...
		<div class="wrap wpsc-table">
			<h2><a href="admin.php?page=wp-spellcheck-grammar.php"><img src="<?php echo plugin_dir_url( __FILE__ ) . 'images/logo.png'; ?>" alt="WP Spell Check" /></a> <span style="position: relative; top: -8px;"> - Broken Code Scan Results</span></h2>
			...
			<form action="<?php echo admin_url('admin.php'); ?>" method='GET'>
				...
				<p class="submit"><input style="background-color: #ffb01f; border-color: #ffb01f; box-shadow: 0px 1px 0px #ffb01f; text-shadow: 1px 1px 1px #ffb01f; font-weight: bold;" type="submit" name="submit" id="submit" class="button button-primary wpscScan" value="Entire Site"></p>
				...
				<div style="padding: 5px; background: white; font-size: 12px;">
					...
					<?php echo "<h3 class='sc-message' style='color: rgb(0, 115, 0);' id='wpscScanMessage'>$scan_message</h3>"; ?>
                                        <?php echo "<h3 class='sc-message' style='color: rgb(0, 115, 0);'>Last scan took " . $options_list[27]->option_value . "</h3><br />"; ?>
					<?php if ((($post_count + $page_count) > $max_pages) & $ent_included) echo "<h3 class='sc-message' style='color: rgb(225, 0, 0);'>You have more than $max_pages Pages/Posts. <a href='https://www.wpspellcheck.com/product-tour/?utm_source=baseplugin&utm_campaign=&utm_medium=bc_scan&utm_content=$wpsc_version' target='_blank'>Upgrade</a> to scan all of your website.</h3>" ?>
					<?php if (!$ent_included) echo "<h3 class='sc-message' style='color: rgb(225, 0, 0);'><a href='https://www.wpspellcheck.com/product-tour/?utm_source=baseplugin&utm_campaign=upgradeBroken_code&utm_medium=bc_scan&utm_content=$wpsc_version' target='_blank'>Upgrade</a> to scan all parts of your website.</h3>"; ?>
				</div>
			</form>
	 ...
	 ?>
		...
		<?php } else { ?>
			<?php if ($pro_error_msg == "") { ?>
				<?php include("sidebar.php"); ?>
				<form action="<?php echo admin_url('admin.php'); ?>" method='GET' style="width: 75%; float: left; margin-top: 10px;">
				<input type="hidden" name="page" value="wp-spellcheck-html.php">
				<input type="hidden" name="action" value="check">
			...
			<h3><a href="https://www.wpspellcheck.com/product-tour/?utm_source=baseplugin&utm_campaign=upgradeBroken_code&utm_medium=bc_scan&utm_content=<?php echo $wpsc_version; ?>" target="_blank">Upgrade to pro</a> to find broken HTML and broken Shortcodes on your website.</h3>
			...
			<div>&lt;h1&gt;Broken Header Title&lt;/h1&gt;
                            <h3><a href="https://www.wpspellcheck.com/product-tour/?utm_source=baseplugin&utm_campaign=upgradeBroken_code&utm_medium=bc_scan&utm_content=<?php echo $wpsc_version; ?>" target="_blank">Upgrade to pro</a> to find and fix the errors. You will also get notified when errors show up on your website.</h3>
		<?php } ?>
		</div>
	<?php 
	}
