						...
						?>
							<label for="wpsc_survey_option_not_working" class="wpsc_survey_label">
								...
								<div class="wpsc_survey_option_details">Would you like us to contact you to fix this issue?<br />
									...
									<div class="wpsc-contact-form"><a href="https://www.wpspellcheck.com/support?utm_source=baseplugin&utm_campaign=plugindeac&utm_content=8.1" target="_blank">Click Here</a> to get in touch with us</div>
								</div>
							</label>
							<?php
								} elseif ($number == 2) {
							...
							<label for="wpsc_survey_option_dont_know" class="wpsc_survey_label">
								...
								<div class="wpsc_survey_option_details">You may check out our <strong>free video tutorials</strong> for WP Spell Check <a href="https://www.wpspellcheck.com/support?utm_source=baseplugin&utm_campaign=plugindeac&utm_content=8.1" target="_blank">here</a></div>
							</label>
							<?php
								} elseif ($number == 3) {
							?>
